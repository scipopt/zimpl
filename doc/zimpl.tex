% $Id: zimpl.tex,v 1.51 2014/03/03 16:44:04 bzfkocht Exp $
...
%*   Copyright (C) 2010 by Author, All rights reserved                       *
%*                                                                           *
%* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
%
...
pdfsubject={Zuse Institute Mathematical Programming Language Version 3.3.2},
...
\author{Thorsten Koch}
\date{\small for Version 3.3.2\\ Feburary 27, 2014}
\maketitle
%
\tableofcontents
\newpage
...
in order to include them into the main distribution.
