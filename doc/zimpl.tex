% $Id: zimpl.tex,v 1.8 2002/10/29 10:42:47 bzfkocht Exp $
%* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
%*                                                                           */
%*   File....: zimpl.tex                                                     */
...
\rcsInfo $Id: zimpl.tex,v 1.8 2002/10/29 10:42:47 bzfkocht Exp $
%
\parindent0ex
...
\author{Thorsten Koch}
\date{\small for Version 1.04\\20. October 2002}
\maketitle
\vfill
\begin{abstract}
...
\code{ln} (logarithm with base $e$), \code{exp} ($e^x$), \code{$!$}. 
