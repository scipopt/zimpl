% $Id: zimpl.tex,v 1.32 2005/02/09 08:56:12 bzfkocht Exp $
%* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
%*                                                                           *
%*   File....: zimpl.tex                                                     *
...
pdfsubject={Zuse Institute Mathematical Programming Language Version 2.03},
...
\rcsInfo $Id: zimpl.tex,v 1.32 2005/02/09 08:56:12 bzfkocht Exp $
%
%\parindent0ex
...
\author{Thorsten Koch}
\date{\small for Version 2.03\\15. February 2005}
\maketitle
\vfill
\tableofcontents
\newpage
