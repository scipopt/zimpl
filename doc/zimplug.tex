...
Programming System/360 \citep{Kallrath2004b,Spielberg2004} in the sixties.
...
looks as shown in Figure~\ref{fig:mps-file}. 

\begin{figure}[hbtp]
\lstset{language=mps,%
basicstyle=\sffamily\footnotesize,%
labelstyle=\sffamily\tiny\color{siennabrown},labelstep=1}
\begin{lstlisting}[frame=b]{}
    NAME        ex1.mps
    ROWS
     N  OBJECTIV          
     L  c1                
    ...
    ENDATA
\end{lstlisting}
\caption{\mps file format example}
\label{fig:mps-file}
\end{figure}
...
\citet[Chapter 1, page 3]{Chvatal1983}.
...
x_{f}&\in\NNZ&&\fa f\in F\label{eqn:integrality}
\end{align}
...
\citet[Section 58.5]{Schrijver2003}.
...
\min\sum_{p\in P}c_p z_p& 
   +\!\!\!\sum_{p\in P, s\in S}\!\!\!c_{ps} z_{ps}&&\mbox{subject to}\nonumber\\ 
...
\lstset{language=zimpl,%
basicstyle=\sffamily\footnotesize,%
labelstyle=\sffamily\tiny\color{siennabrown},labelstep=1,escapechar=@}
\begin{lstlisting}[frame=tb]{}
param columns := 8;
...
basicstyle=\sffamily\footnotesize,%
labelstyle=\sffamily\tiny\color{siennabrown},labelstep=1}
\begin{lstlisting}[firstlabel=13]{}
...
basicstyle=\sffamily\footnotesize,%
labelstyle=\sffamily\tiny\color{siennabrown},labelstep=1}
\begin{lstlisting}[frame=tb,firstlabel=13]{}
