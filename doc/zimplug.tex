% $Id: zimplug.tex,v 1.1 2003/10/01 08:51:12 bzfkocht Exp $
%* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
%*                                                                           *
%*   File....: zimplug.tex                                                   *
...
\begin{eqnarray}
\sum_{p\in P} x_{ps}& =& 1\quad\forall s\in S\\
x_{ps}&\leq&z_{s}\quad\forall s\in S, p\in P\\
\sum_{s\in S} \delta_s x_{ps}&\leq&\kappa_p\quad\forall p\in P
\end{eqnarray}
