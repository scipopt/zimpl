% $Id: zimplug.tex,v 1.17 2004/05/03 11:35:15 bzfkocht Exp $
%* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
%*                                                                           *
%*   File....: zimplug.tex                                                   *
...
\item[193 Different dimension tuples in set initialisation]\ \\
  The tuples that should be part of th elist have different dimension.
\item[194: Indexing tuple \code{xxx} has wrong dimension
           \code{yyy}, expected \code{zzz}]\ \\
  The index tuple of an entry in a paramter initialization list must
  have the same dimension as the indexing set of the parameter. This
  is just another kind of error 134.
\item[195: Empty index set for parameter]\ \\
