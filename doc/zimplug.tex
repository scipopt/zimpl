% $Id: zimplug.tex,v 1.2 2003/10/02 08:20:12 bzfkocht Exp $
%* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
%*                                                                           *
%*   File....: zimplug.tex                                                   *
...
And the formulation in \zimpl follows. Please note that \code{P[]}
...
to be build. And we have binary variables $x_ps$, 
