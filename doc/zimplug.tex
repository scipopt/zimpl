...
-t \emph{format} & Selects the output format. Can be either \code{lp},
		  ...
		  means Polynomial IP, or \code{qbo} which means QUBO.\\
...
\item[qubo]
  Transform the constraint into an qudratic qbjective.
  Currently, this only works with a sum of binary variables equal to one.
\end{description}
