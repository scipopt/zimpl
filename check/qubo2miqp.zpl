...
param nodes := read filename as "1n" use 1;

# should also work with using edges. But this way there can be other stuff
# behind the edges and we won't care.
param edges := read filename as "2n" use 1; 

set I := { 1 .. nodes };

set E := { read filename as "<1n,2n>" skip 1 use edges };

param weight[I*I] := read filename as "<1n,2n> 3n" skip 1 use edges;
