...
#* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
#*
#* Copyright (C) 2005-2026 by Thorsten Koch <koch@zib.de>
#*
...
cppcheck:	$(OBJSRC) $(LIBSRC) compile_commands.json
		$(CPPCHECK) --project=compile_commands.json --suppressions-list=src/cppcheck.txt -D__GMP_H__ --inline-suppr \
